...
// Entry rule entryRuleMatnModel
entryRuleMatnModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMatnModelRule()); }
	iv_ruleMatnModel=ruleMatnModel
	{ $current=$iv_ruleMatnModel.current; }
	EOF;

// Rule MatnModel
ruleMatnModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
