...
public class MatnSemanticSequencer extends OsolQiraaSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (rakm=INT sadr+=AWORD+ ajoz+=AWORD+)
	 */
	protected void sequence_Bayt(ISerializationContext context, Bayt semanticObject) {
	 ...
	 *
	 * Constraint:
	 *     (name=AWORDS abyatCount=INT abyat+=Bayt+)
	 */
	...
	/**
	 * Contexts:
	 *     MatnModel returns MatnModel
	 *
	 * Constraint:
	 *     matn=Matn
	 */
	protected void sequence_MatnModel(ISerializationContext context, MatnModel semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MatnPackage.Literals.MATN_MODEL__MATN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MatnPackage.Literals.MATN_MODEL__MATN));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getMatnModelAccess().getMatnMatnParserRuleCall_0(), semanticObject.getMatn());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=AWORDS makateh+=Maktah+)
	 */
	protected void sequence_Matn(ISerializationContext context, Matn semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
