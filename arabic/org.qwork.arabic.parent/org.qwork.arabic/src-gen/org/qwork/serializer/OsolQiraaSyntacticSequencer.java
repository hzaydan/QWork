...
public class OsolQiraaSyntacticSequencer extends AbstractSyntacticSequencer {

	protected OsolQiraaGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (OsolQiraaGrammarAccess) access;
	}
