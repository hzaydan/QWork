...
public class ArabicSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ArabicGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (ArabicGrammarAccess) access;
	}
