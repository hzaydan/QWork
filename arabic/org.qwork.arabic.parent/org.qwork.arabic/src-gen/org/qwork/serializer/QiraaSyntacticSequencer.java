...
public class QiraaSyntacticSequencer extends AbstractSyntacticSequencer {

	protected QiraaGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (QiraaGrammarAccess) access;
	}
