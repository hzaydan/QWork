...
public class InternalQAyahStartLexer extends Lexer {
    ...
    public final void mRULE_ALETTER() throws RecognitionException {
        try {
            // InternalQAyahStart.g:467:23: ( '\\u0621' .. '\\u064A' )
            // InternalQAyahStart.g:467:25: '\\u0621' .. '\\u064A'
            {
            matchRange('\u0621','\u064A'); 
    ...
    public final void mRULE_ADIGIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:469:13: ( '\\u0660' .. '\\u0669' )
            // InternalQAyahStart.g:469:15: '\\u0660' .. '\\u0669'
            {
            matchRange('\u0660','\u0669'); 
    ...
    public final void mRULE_AHARAKAH() throws RecognitionException {
        try {
            // InternalQAyahStart.g:471:24: ( ( '\\u064E' .. '\\u0650' | '\\u0652' ) )
            // InternalQAyahStart.g:471:26: ( '\\u064E' .. '\\u0650' | '\\u0652' )
            {
    ...
    public final void mRULE_ASHADDAH() throws RecognitionException {
        try {
            // InternalQAyahStart.g:473:24: ( '\\u0651' )
            // InternalQAyahStart.g:473:26: '\\u0651'
            {
            match('\u0651'); 
    ...
    public final void mRULE_ANONLETTER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:475:17: ( ( '\\u0600' .. '\\u0620' | '\\u064B' .. '\\u06FF' ) )
            // InternalQAyahStart.g:475:19: ( '\\u0600' .. '\\u0620' | '\\u064B' .. '\\u06FF' )
            {
    ...
    public final void mRULE_AWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:477:12: ( ( RULE_ALETTER | RULE_AHARAKAH | RULE_ASHADDAH )+ )
            // InternalQAyahStart.g:477:14: ( RULE_ALETTER | RULE_AHARAKAH | RULE_ASHADDAH )+
            {
            // InternalQAyahStart.g:477:14: ( RULE_ALETTER | RULE_AHARAKAH | RULE_ASHADDAH )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_KALEMAH() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:479:14: ( '\"' ( options {greedy=false; } : . )* '\"' )
            // InternalQAyahStart.g:479:16: '\"' ( options {greedy=false; } : . )* '\"'
            {
            match('\"'); 
            // InternalQAyahStart.g:479:20: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:481:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalQAyahStart.g:481:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalQAyahStart.g:481:11: ( '^' )?
            int alt3=2;
            ...
            // InternalQAyahStart.g:481:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:483:10: ( ( '0' .. '9' )+ )
            // InternalQAyahStart.g:483:12: ( '0' .. '9' )+
            {
            // InternalQAyahStart.g:483:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalQAyahStart.g:483:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:485:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalQAyahStart.g:485:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalQAyahStart.g:485:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalQAyahStart.g:485:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalQAyahStart.g:485:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalQAyahStart.g:485:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalQAyahStart.g:485:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:487:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalQAyahStart.g:487:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalQAyahStart.g:487:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:489:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalQAyahStart.g:489:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalQAyahStart.g:489:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:491:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalQAyahStart.g:491:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalQAyahStart.g:491:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQAyahStart.g:493:16: ( . )
            // InternalQAyahStart.g:493:18: .
            {
            matchAny(); 
