...
public class InternalAbjadLexer extends Lexer {
    ...
    public final void mRULE_BASMALAH() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:992:15: ( '\\u0628\\u0650\\u0633\\u0652\\u0645\\u0650 \\u0627\\u0644\\u0644\\u0651\\u064E\\u0647\\u0650 \\u0627\\u0644\\u0631\\u0651\\u064E\\u062D\\u0652\\u0645\\u064E\\u0646\\u0650 \\u0627\\u0644\\u0631\\u0651\\u064E\\u062D\\u0650\\u064A\\u0645\\u0650' )
            // InternalAbjad.g:992:17: '\\u0628\\u0650\\u0633\\u0652\\u0645\\u0650 \\u0627\\u0644\\u0644\\u0651\\u064E\\u0647\\u0650 \\u0627\\u0644\\u0631\\u0651\\u064E\\u062D\\u0652\\u0645\\u064E\\u0646\\u0650 \\u0627\\u0644\\u0631\\u0651\\u064E\\u062D\\u0650\\u064A\\u0645\\u0650'
            {
    ...
    public final void mRULE_AWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:994:12: ( ( RULE_ALETTER | RULE_AHARAKAH | RULE_ATANWEEN | RULE_ASHADDAH )+ )
            // InternalAbjad.g:994:14: ( RULE_ALETTER | RULE_AHARAKAH | RULE_ATANWEEN | RULE_ASHADDAH )+
            {
            // InternalAbjad.g:994:14: ( RULE_ALETTER | RULE_AHARAKAH | RULE_ATANWEEN | RULE_ASHADDAH )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_ALIGATURES() throws RecognitionException {
        try {
            // InternalAbjad.g:996:26: ( '\\uFDF0' .. '\\uFDFD' )
            // InternalAbjad.g:996:28: '\\uFDF0' .. '\\uFDFD'
            {
            matchRange('\uFDF0','\uFDFD'); 
    ...
    public final void mRULE_ALETTER() throws RecognitionException {
        try {
            // InternalAbjad.g:998:23: ( '\\u0621' .. '\\u064A' )
            // InternalAbjad.g:998:25: '\\u0621' .. '\\u064A'
            {
            matchRange('\u0621','\u064A'); 
    ...
    public final void mRULE_ADIGIT() throws RecognitionException {
        try {
            // InternalAbjad.g:1000:22: ( '\\u0660' .. '\\u0669' )
            // InternalAbjad.g:1000:24: '\\u0660' .. '\\u0669'
            {
            matchRange('\u0660','\u0669'); 
    ...
    public final void mRULE_ATANWEEN() throws RecognitionException {
        try {
            // InternalAbjad.g:1002:24: ( '\\u064B' .. '\\u064D' )
            // InternalAbjad.g:1002:26: '\\u064B' .. '\\u064D'
            {
            matchRange('\u064B','\u064D'); 
    ...
    public final void mRULE_AHARAKAH() throws RecognitionException {
        try {
            // InternalAbjad.g:1004:24: ( ( '\\u064E' .. '\\u0650' | '\\u0652' ) )
            // InternalAbjad.g:1004:26: ( '\\u064E' .. '\\u0650' | '\\u0652' )
            {
    ...
    public final void mRULE_ASHADDAH() throws RecognitionException {
        try {
            // InternalAbjad.g:1006:24: ( '\\u0651' )
            // InternalAbjad.g:1006:26: '\\u0651'
            {
            match('\u0651'); 
    ...
    public final void mRULE_ANONLETTER() throws RecognitionException {
        try {
            // InternalAbjad.g:1008:26: ( ( '\\u0600' .. '\\u0620' | '\\u064B' .. '\\u06FF' ) )
            // InternalAbjad.g:1008:28: ( '\\u0600' .. '\\u0620' | '\\u064B' .. '\\u06FF' )
            {
    ...
    public final void mRULE_KALEMAH() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:1010:14: ( '\"' ( options {greedy=false; } : . )* '\"' )
            // InternalAbjad.g:1010:16: '\"' ( options {greedy=false; } : . )* '\"'
            {
            match('\"'); 
            // InternalAbjad.g:1010:20: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:1012:17: ( 'deactivated' )
            // InternalAbjad.g:1012:19: 'deactivated'
            {
            match("deactivated"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:1014:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalAbjad.g:1014:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalAbjad.g:1014:11: ( '^' )?
            int alt3=2;
            ...
            // InternalAbjad.g:1014:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:1016:10: ( ( '0' .. '9' )+ )
            // InternalAbjad.g:1016:12: ( '0' .. '9' )+
            {
            // InternalAbjad.g:1016:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:1018:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalAbjad.g:1018:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalAbjad.g:1018:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalAbjad.g:1018:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalAbjad.g:1018:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalAbjad.g:1018:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalAbjad.g:1018:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:1020:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalAbjad.g:1020:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalAbjad.g:1020:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:1022:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalAbjad.g:1022:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalAbjad.g:1022:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAbjad.g:1024:16: ( . )
            // InternalAbjad.g:1024:18: .
            {
            matchAny(); 
